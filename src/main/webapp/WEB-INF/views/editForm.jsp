			...
			<div id="app-board" class="app-board-skin">
				<div class="card">
					<div class="app-board-section app-board-section-padding">
						<form action="editing-complete/${post.no}" method="post">
							...
							<div class="tw-flex tw-items-center sm:tw-block tw-mb-6">
								<input type="text" name="title" title="제목" placeholder="제목을 입력해주세요." class="app-input tw-flex-1 sm:tw-w-full" value="${post.title}">
							</div>
							<div class="tw-flex tw-items-center sm:tw-block tw-mb-6">
									<textarea name="content" class="app-input tw-flex-1 sm:tw-w-full">${post.content}</textarea>
							</div>
								<!-- 버튼 -->
							<div class="sm:tw-block tw-flex tw-items-center">
								...
								<!-- 우측 -->
								<div class="tw-flex">
									<a href="/visit/${post.no}" class="app-button tw-mr-2 sm:tw-flex-1">취소</a>
